...
public class testISFGS_ShyamData {
	public static void main(String[] args) {

		String pathToData = "/Users/fattanehjabbari/CCD-Project/CS-BN/Shyam-data/hf_death_di.csv";
...
//			double k_reverse = k_add;
		...
		try {
			File dir = new File("/Users/fattanehjabbari/CCD-Project/CS-BN/Shyam-data/outputs");
			dir.mkdirs();
			String outputFileName = "hf_death_di-Kappa"+ k_add +".csv";

			File file = new File(dir, outputFileName);
			out = new PrintStream(new FileOutputStream(file));
			outputFileName = "hf_death_di-AUROC-Kappa"+ k_add +".csv";
		...
		for (int i = 0; i < trainDataOrig.getNumRows(); i++){
			...
			probs_is[i]= estimation(trainData67, test67, graphI, target);
