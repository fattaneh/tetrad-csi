...
//				double alpha = 0, cutoff = 0.5, edgesPerNode = 2.0, latent = 0.2;
//				int numVars = 50, numCases = 2000, numTests = 10, numSim = 1;
//
...
//		try {
//			File dir = new File(data_path + "/simulation-Rfci-" + scoreType + "(WO)/");
//
//			dir.mkdirs();
//			String outputFileName = "V"+numVars +"-E"+ edgesPerNode +"-L"+ latent + "-N" + numCases +  "-Th" + threshold  + "-C" + cutoff  +"-Rfci-" + scoreType+"(WO).csv";
