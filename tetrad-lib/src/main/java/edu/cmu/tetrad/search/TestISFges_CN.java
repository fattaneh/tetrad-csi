...
public class TestISFges_CN {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("trainData size: " + trainData.getNumRows() +", " + trainData.getNumColumns());
			System.out.println("testData size: " + testData.getNumRows() +", " + testData.getNumColumns());
