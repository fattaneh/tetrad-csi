...
/**
 * Random Bayesian Independence Test fro Continuous data
 *
 * @author Fattaneh Jabbari
 */
public class IndTestProbabilisticContinuous implements IndependenceTest {
    ...
    public IndTestProbabilisticContinuous(DataSet data) {
        this.data = data;
