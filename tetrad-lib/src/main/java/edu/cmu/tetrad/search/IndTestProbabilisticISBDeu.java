...
//				boolean first = true;
				...
				if(data_is.getNumRows() > 0){ 
					BDeuScorWOprior bic_is = new BDeuScorWOprior(data_is);
//					pInd_is = computeIndWithMultipleStructures(bic_is, x, y, z);
				...
				BDeuScorWOprior bic_res = new BDeuScorWOprior(data_rest);
...
//			System.out.println("pInd_is: " + pInd_is);
	...
	private double computeIndWithMultipleStructures(BDeuScorWOprior bic, Node x, Node y, Node... z) {
		double pInd = Double.NaN;
