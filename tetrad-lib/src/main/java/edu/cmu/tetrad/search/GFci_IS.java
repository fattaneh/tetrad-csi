 ...
 * @author Fattaneh
 */
public final class GFci_IS implements GraphSearch {
    ...
    //============================CONSTRUCTORS============================//
    public GFci_IS(IndependenceTest test, ISScore score) {
        if (score == null) {
    ...
    public GFci_IS(IndependenceTest test, ISScore score, Graph populationGraph) {
        if (score == null) {
            throw new NullPointerException();
        }
        this.sampleSize = score.getSampleSize();
